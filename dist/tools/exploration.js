 ...
 */
export async function getInterestingFacts(location, threshold = 0.05, limit = 20, category) {
    ...
    let categoryFilter = '';
    const params = [geo_id, 1 - threshold, threshold];
